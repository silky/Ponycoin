...
"for example: alertnotify=echo %%s | mail -s \"Ponycoin Alert\" derpy@20percentcooler.com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Ponycoin Wiki for SSL setup instructions)"),
